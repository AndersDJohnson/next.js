...
export default function onRecoverableError(err: any, errorInfo: ErrorInfo) {
  // Attach component stack to error so it's accessible even when passed thru `reportError` below,
  ...
  // This is technically a mutation of an argument, which isn't generally advisable, but probably not problematic in this case.
